...
def posts_new_form(user_id):
    """Show form to create new post for user."""
...
def posts_edit(post_id):
    """Show form for user to edit post."""
...
@app.route('/tags')
def tags_index():
    """Show page with info for all tags."""
...
def tags_edit(tag_id):
    """Handle update form of existing tag"""
...
def tags_destroy(tag_id):
    """Adds option to delete an existing tag"""
